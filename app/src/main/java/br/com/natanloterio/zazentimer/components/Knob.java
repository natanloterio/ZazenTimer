...
public class Knob extends View {
   ...
   synchronized void displayBalloons() {
    ...
    void loadAttributes(AttributeSet attrs) {
        ...
        TypedArray typedArray = ctx.obtainStyledAttributes(attrs, it.beppi.knoblibrary.R.styleable.Knob);

        numberOfStates = typedArray.getInt(it.beppi.knoblibrary.R.styleable.Knob_kNumberOfStates, numberOfStates);
        defaultState = typedArray.getInt(it.beppi.knoblibrary.R.styleable.Knob_kDefaultState, defaultState);

        borderWidth = typedArray.getDimensionPixelSize(it.beppi.knoblibrary.R.styleable.Knob_kBorderWidth, borderWidth);
        borderColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kBorderColor, borderColor);

        indicatorWidth = typedArray.getDimensionPixelSize(it.beppi.knoblibrary.R.styleable.Knob_kIndicatorWidth, indicatorWidth);
        indicatorColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kIndicatorColor, indicatorColor);
        indicatorRelativeLength = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kIndicatorRelativeLength, indicatorRelativeLength);

        circularIndicatorRelativeRadius = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kCircularIndicatorRelativeRadius, circularIndicatorRelativeRadius);
        circularIndicatorRelativePosition = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kCircularIndicatorRelativePosition, circularIndicatorRelativePosition);
        circularIndicatorColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kCircularIndicatorColor, circularIndicatorColor);

        knobColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kKnobColor, knobColor);
        knobRelativeRadius = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kKnobRelativeRadius, knobRelativeRadius);

        knobCenterRelativeRadius = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kKnobCenterRelativeRadius, knobCenterRelativeRadius);
        knobCenterColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kKnobCenterColor, knobCenterColor);

        knobDrawableRes = typedArray.getResourceId(it.beppi.knoblibrary.R.styleable.Knob_kKnobDrawable, knobDrawableRes);
        knobDrawableRotates = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kKnobDrawableRotates, knobDrawableRotates);

        stateMarkersWidth = typedArray.getDimensionPixelSize(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersWidth, stateMarkersWidth);
        stateMarkersColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersColor, stateMarkersColor);
        selectedStateMarkerColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kSelectedStateMarkerColor, selectedStateMarkerColor);
        stateMarkersRelativeLength = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersRelativeLength, stateMarkersRelativeLength);
        selectedStateMarkerContinuous = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kSelectedStateMarkerContinuous, selectedStateMarkerContinuous);

        animation = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kAnimation, animation);
        animationSpeed = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kAnimationSpeed, animationSpeed);
        animationBounciness = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kAnimationBounciness, animationBounciness);

        swipeDirection = swipeAttrToInt(typedArray.getString(it.beppi.knoblibrary.R.styleable.Knob_kSwipe));
        swipeSensibilityPixels = typedArray.getInt(it.beppi.knoblibrary.R.styleable.Knob_kSwipeSensitivityPixels, swipeSensibilityPixels);

        freeRotation = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kFreeRotation, freeRotation);
        minAngle = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kMinAngle, minAngle);
        maxAngle = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kMaxAngle, maxAngle);

        stateMarkersAccentWidth = typedArray.getDimensionPixelSize(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersAccentWidth, stateMarkersAccentWidth);
        stateMarkersAccentColor = typedArray.getColor(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersAccentColor, stateMarkersAccentColor);
        stateMarkersAccentRelativeLength = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersAccentRelativeLength, stateMarkersAccentRelativeLength);
        stateMarkersAccentPeriodicity = typedArray.getInt(it.beppi.knoblibrary.R.styleable.Knob_kStateMarkersAccentPeriodicity, stateMarkersAccentPeriodicity);

        showBalloonValues = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kShowBalloonValues, showBalloonValues);
        balloonValuesTimeToLive = typedArray.getInt(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesTimeToLive, balloonValuesTimeToLive);
        balloonValuesRelativePosition = typedArray.getFloat(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesRelativePosition, balloonValuesRelativePosition);
        balloonValuesTextSize = typedArray.getDimension(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesTextSize, balloonValuesTextSize);
        balloonValuesAnimation = balloonAnimationAttrToInt(typedArray.getString(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesAnimation));
        balloonValuesArray = typedArray.getTextArray(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesArray);
        balloonValuesSlightlyTransparent = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kBalloonValuesSlightlyTransparent, balloonValuesSlightlyTransparent);

        clickBehaviour = clickAttrToInt(typedArray.getString(it.beppi.knoblibrary.R.styleable.Knob_kClickBehaviour));

        enabled = typedArray.getBoolean(it.beppi.knoblibrary.R.styleable.Knob_kEnabled, enabled);
